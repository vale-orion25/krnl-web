...
const PASOS = [
  ...
  { n: "03", label: "Te asignamos un especialista",       sub: "Con prioridad, en horario hábil" },
  { n: "04", label: "Primer paso juntos",                 sub: "Lo definimos contigo" },
];

const CERTS = ["ISO 27001", "ISO 9001", "+25 años", "Casos productivos"];
...
function FormContacto({ onSend }: { onSend: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      {/* Submit */}
      <button type="submit"
        className="inline-flex items-center justify-center gap-2 px-7 py-2.5 rounded-full font-[600] text-white text-[14px] transition-all hover:scale-[1.03] active:scale-[0.98]"
        style={{ background: GRAD, boxShadow: `0 6px 28px ${B.purple}40` }}>
        Enviar mensaje <ArrowRight className="w-4 h-4" strokeWidth={2.2} />
      </button>
    </form>
  );
}
  ...
  return (
    <motion.div className="flex flex-col items-center text-center py-14 px-6"
      ...
      <p className="text-[15px] leading-relaxed mb-8" style={{ color: B.textSub, maxWidth: 400 }}>
        Tu consulta fue recibida. El equipo de Orión se pondrá en contacto contigo a la brevedad, en horario hábil, para dar el siguiente paso.
      </p>
...
function HeroContacto() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden pt-[104px] pb-10"
      ...
      <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-64 h-40 sm:w-[500px] sm:h-[280px] rounded-full pointer-events-none"
          ...
          <motion.div className="rounded-2xl overflow-hidden"
            ...
            <div className="flex items-center gap-2 px-6 py-4" style={{ borderBottom: `1px solid ${B.borderSoft}`, background: B.softBg }}>
              ...
              <div className="ml-auto flex items-center gap-1.5">
                ...
                <span className="text-[10px]" style={{ color: B.textMuted }}>Orión responde</span>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <motion.div className="rounded-2xl p-5 relative overflow-hidden"
              ...
              <p className="text-[12px] leading-relaxed mb-4" style={{ color: B.textSub }}>
                Implementación, ciberseguridad y operación continua de KRNL con +25 años de experiencia enterprise.
              </p>
