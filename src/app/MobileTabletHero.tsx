    ...
    >
      <div className="relative px-5 sm:px-6 pt-24 pb-14 sm:pt-28 sm:pb-16">
        ...
        <motion.button
          ...
          onClick={onCTAClick}
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 rounded-full text-[14px] font-[600] text-white active:scale-[0.98] transition-transform"
          style={{ background: GRAD, boxShadow: `0 4px 16px ${B.purple}40`, minHeight: 42 }}
        >
