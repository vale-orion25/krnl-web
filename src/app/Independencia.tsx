...
function HeroIndependencia() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden pt-[104px] pb-20"
      ...
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[600px] h-[340px] rounded-full pointer-events-none"
      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-10 py-14 md:py-20">
        <motion.div className="text-center mb-12"
          ...
          <p style={{ color: B.textSub, fontSize: 16, maxWidth: 500, margin: "0 auto" }}>
            El lock-in no es solo técnico. Afecta costos, visibilidad, conocimiento institucional y capacidad de cambio.
          </p>
        </motion.div>
              ...
              <div className="p-5">
                ...
                <div className="flex flex-col gap-2.5 mb-4">
                  {[
                    ...
                    { label: "Registro activo",    val: "Auditoría completa · Inmutable" },
                  ].map(({ label, val }) => (
...
function SectionCambioModelo() {
  ...
  const sinKrnl = [
    ...
    "No hay visibilidad ni gobierno central",
  ];
  const conKrnl = [
    ...
    <section ref={ref} style={{ background: B.surface, borderTop: `1px solid ${B.border}` }}>
      <div className="max-w-[1200px] mx-auto px-5 md:px-10 py-14 md:py-20">
        <motion.div className="text-center mb-12"
          ...
          <p style={{ color: B.textSub, fontSize: 16, maxWidth: 520, margin: "0 auto" }}>
            KRNL garantiza independencia en cada dimensión crítica de la operación de IA empresarial.
          </p>
        </motion.div>
